...
class comment:
    ...
    def get_comment_data(self):
        ...
        for id in ids:
            ...
            #格式转换
            try:
                music_comments = json.loads(music_comments)
                hot_comments = music_comments["hotComments"]
            except:
                pass
            ...
            for item in hot_comments:
                ...
                try :
                    ...
                    pass
            try :
                TITLE["评论总数"] = music_comments["total"]
...
name_list = ["billboard_list","china_top_list","classical_list","electric_list","hip_pop_list","hot_list",
             "most_comments_list","new_list","original_list","upgrade_list"]
...
"""
导出数据库命令
D:\programs\MongoDB\bin>mongoexport.exe -d PopSongs -c billboard_list -o E:\projects\python\spyder\Music\data\musics\billboard_list.json --type json
"""